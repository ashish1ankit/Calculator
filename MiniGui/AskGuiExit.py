...
def cquit():#quiting custom message box function
    answer=tkinter.messagebox.askokcancel("Are you sure you want to exit?","The Contetnts without save will be lost!!")
    if answer:
        print("Exiting....")
        quit()
def save():
